...
public class InputHandler {
    ...
    public Packet receive() {
        ...
        try {
            ...
            logger.log(Level.WARNING, "[InputHandler] Failed to receive packet (Class not found)");
        } catch (IOException ex) {
            logger.log(Level.WARNING, "[InputHandler] Failed to receive packet (IO failure)");
        }
        return null;
    }
